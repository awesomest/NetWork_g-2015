...
set grid ytics
set out "./informspread/${1}_data/NOISEIMAGE/noise_${1}_time${3}_image.eps"
...
plot "./informspread/${1}_data/NC_noise/NC_noise_${1}_time${3}.dat" using 1:3 title 'NC' w lp linestyle 1,\
"./informspread/${1}_data/IC_noise/IC_noise_${1}_time${3}.dat" using 1:3 title "IC" w lp linestyle 2,\
"./informspread/${1}_data/DC_asc_noise/DC_asc_noise_${1}_time${3}.dat" using 1:3 title "DC_asc" w lp linestyle 3,\
"./informspread/${1}_data/DC_desc_noise/DC_desc_noise_${1}_time${3}.dat" using 1:3 title "DC_desc" w lp linestyle 4
exit
EOF
