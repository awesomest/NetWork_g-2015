...
set title "collision_${1}_time${3}_memo"
#set out "test.eps"
set xlabel "time"
set ylabel "collision count"
set xrange[-1:]
...
gnuplot << EOF
set terminal postscript eps
set title "collision_${1}_time${3}_not_memo"
#set out "test.eps"
set xlabel "time"
set ylabel "collision count"
set xrange[-1:]
set yrange[0:`expr ${2} + ${2} \* 4 / 10`]
set grid ytics
set out "./informspread_not_mem/${1}_data/NOISEIMAGE/collision/collision_${1}_time${3}_image.eps"
set style line 1 lt 1 lc rgb "red" lw 3 ps 2 
set style line 2 lt 1 lc rgb "green" lw 3 ps 2
set style line 5 lt 1 lc rgb "magenta" lw 3 ps 2
plot "./informspread_not_mem/${1}_data/NC_noise/NC_noise_${1}_time${3}.dat" using 1:3 title 'NC' w p linestyle 1,\
"./informspread_not_mem/${1}_data/IC_noise/IC_noise_${1}_time${3}.dat" using 1:3 title "IC" w p linestyle 2,\
"./informspread_not_mem/${1}_data/PC_noise/PC_noise_${1}_time${3}.dat" using 1:2 title "PC" w lp linestyle 5
exit
EOF
fi
